    ...
    <div className="h-px flex-1 max-w-28 relative overflow-hidden bg-primary/10">
      <div
        ...
        style={{
          ...
          transition: `transform 1.0s ease ${delay}ms`,
        }}
      />
    </div>
  )
    ...
    >
        ...
        <div className="w-52 h-52 md:w-64 md:h-64 rounded-full border border-primary/18 flex items-center justify-center overflow-hidden">
          <div
            ...
            style={{
              ...
              transition: `transform 1.0s cubic-bezier(0.16,1,0.3,1) ${delay + 200}ms`,
            }}
          >
            <Image
              src={image}
      ...
      <div
        style={{
          ...
          transition: `opacity 0.8s ease ${delay + 350}ms, transform 0.8s ease ${delay + 350}ms`,
        }}
      >
          ...
          >
            <div
              ...
              style={{
                ...
                transition: "height 1.1s ease 0.6s",
              }}
            />
